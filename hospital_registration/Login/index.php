...
if(isset($_POST['email']))
{
	...
	$sql ="select * from register where email='".$email."'AND reg='".$reg."' limit 1";
	$result=mysqli_query($con,$sql);
	$row = mysqli_fetch_array($result);
	if($row['email'] == $email && $row['reg'] == $reg)
	{$m=$row['name'];
	...
	<div class="containerw3layouts-agileits">
		...
		<div class="aitsloginwthree w3layouts agileits">
			...
			<form action="#" method="post">
                ...
                <input type="text" Name="reg" placeholder="Enter your Hospital Registration Number" required>
